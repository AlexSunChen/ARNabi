...
public class PreviewStreetViewLayer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.layer_preview, container, false);
    ...
    public void onSensorOrientationChanged(double yaw, double pitch) {
        if (!setPositionFlag) {
            getChildFragmentManager()
                    .beginTransaction()
                    .replace(R.id.previewStreetViewLayout, streetViewPanoramaFragment, "streetView")
                    .commit();
        }
